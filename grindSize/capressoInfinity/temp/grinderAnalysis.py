...
def main(N,smallestIncrement,coffeeCellSize,whichInformation):
    ...
    for a in range(1,N+1): # need to start at 1 because filenames are setting1 - settingEnd
        ...
        valuesArray = np.array(pd.read_csv("data/setting{}_stats.csv".format(a)))
        ...
        dataArray = np.array(pd.read_csv("data/setting{}.csv".format(a)))
